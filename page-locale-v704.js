(() => {
  ...
  const TEXT = new Map(Object.entries({
    ...
    "Traveler share":"حصة المسافرين",
    "Who the spending was for":"لمن كان الإنفاق",
    "Your recent spending days":"أيام الإنفاق الأخيرة",
    "Highest spend day":"أعلى يوم إنفاقًا",
    "Budget pace will appear here":"ستظهر وتيرة الميزانية هنا",
