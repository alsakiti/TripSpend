(() => {
  ...
  const UI = new Map(Object.entries({
    ...
    "Safe today":"المتاح اليوم","☀️ Safe today":"المتاح اليوم ☀️","Spent today":"مصروف اليوم","🧾 Spent today":"مصروف اليوم 🧾","Your balance after upcoming planned costs, divided across the days left in your trip.":"رصيدك بعد التكاليف المخططة القادمة، مقسومًا على الأيام المتبقية في الرحلة.",
    "WHERE YOU ARE":"موقعك الآن","Current trip":"الرحلة الحالية","CURRENT COUNTRY • AUTO BY DATE":"الدولة الحالية • تلقائي حسب التاريخ","Current country • auto by date":"الدولة الحالية • تلقائي حسب التاريخ","No country budget":"لا توجد ميزانية للدولة","NEXT UP":"التالي","Next up":"التالي",
    "YOUR ROUTE":"مسار رحلتك","Country budgets":"ميزانيات الدول","Manage":"إدارة","Tap a country to set its budget.":"اضغط على دولة لتحديد ميزانيتها.","Set budget":"تحديد الميزانية","On track":"ضمن الميزانية","Over budget":"تجاوزت الميزانية","Trip history":"سجل الرحلات","Trips & history":"الرحلات والسجل","No past trips yet • tap to manage trips":"لا توجد رحلات سابقة • اضغط لإدارة الرحلات",
